import { BarChart3, Package, TrendingDown, TrendingUp, Download } from 'lucide-react';
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-2xl p-5 border border-gray-200 hover:shadow-lg transition-shadow">
          <div className="flex flex-col items-center text-center mb-3">
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-1">Produtos por Categoria</h3>
            <p className="text-xs text-gray-600">Distribuição de produtos por categoria</p>
          </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-gray-200 hover:shadow-lg transition-shadow">
          <div className="flex flex-col items-center text-center mb-3">
            ...
            <h3 className="text-lg font-bold text-gray-900 mb-1">Estoque Baixo</h3>
            <p className="text-xs text-gray-600">Produtos com estoque abaixo do mínimo</p>
          </div>
          <button className="w-full bg-[#008080] text-white py-2.5 rounded-lg flex items-center justify-center gap-2 hover:bg-[#006666] transition-colors font-medium text-sm">
            <Download className="w-4 h-4" />
            Gerar Relatório
        ...
        <div className="bg-white rounded-2xl p-5 border border-gray-200 hover:shadow-lg transition-shadow">
          <div className="flex flex-col items-center text-center mb-3">
            ...
            <p className="text-xs text-gray-600">Ranking dos produtos mais vendidos</p>
          </div>
          <button className="w-full bg-[#008080] text-white py-2.5 rounded-lg flex items-center justify-center gap-2 hover:bg-[#006666] transition-colors font-medium text-sm">
            <Download className="w-4 h-4" />
            Gerar Relatório
        ...
        {/* Card 4: Inventário Completo */}
        <div className="bg-white rounded-2xl p-5 border border-gray-200 hover:shadow-lg transition-shadow">
          <div className="flex flex-col items-center text-center mb-3">
            <div className="w-14 h-14 bg-[#008080] rounded-full flex items-center justify-center mb-3">
              <Package className="w-7 h-7 text-white" />
            </div>
            <h3 className="text-lg font-bold text-gray-900 mb-1">Inventário Completo</h3>
            <p className="text-xs text-gray-600">Relatório completo de todos os produtos</p>
          </div>
          <button className="w-full bg-[#008080] text-white py-2.5 rounded-lg flex items-center justify-center gap-2 hover:bg-[#006666] transition-colors font-medium text-sm">
            <Download className="w-4 h-4" />
            Gerar Relatório
